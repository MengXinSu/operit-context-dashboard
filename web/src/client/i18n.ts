...
export const DICT_ZH: Record<string, string> = {
  ...
  'kind.inject': '注入', 'kind.compaction': '压缩', 'kind.prune': '剪枝', 'kind.model': '切换', 'kind.mode': '模式', 'kind.warn': '报错',
  'warn.trunc': '截断', 'warn.empty': '输出异常', 'warn.other': '其他',
  'files.title': '文件活动',
  'files.scopeLatest': '截至最新 · 跟随趋势图的选择',
  'files.scopeOut': '该轮早于当前数据窗口（压缩后仅保留最近记录）',
  'files.openFail': '打开失败：{msg}',
...
export const DICT_EN: Record<string, string> = {
  ...
  'kind.inject': 'Inject', 'kind.compaction': 'Compact', 'kind.prune': 'Prune', 'kind.model': 'Switch', 'kind.mode': 'Mode', 'kind.warn': 'Alert',
  'warn.trunc': 'Truncated', 'warn.empty': 'Empty output', 'warn.other': 'Other',
  'files.title': 'File Activity',
  'files.scopeLatest': 'Up to latest · follows the trend chart pick',
  'files.scopeOut': 'That turn predates the current data window (only recent records are kept after compaction)',
  'files.openFail': 'Open failed: {msg}',
  ...
  'tip.cat': '{cat} ≈ {n}',
  'tip.delta': 'Δ {n}',
  'tip.skip': 'Skipped {n} interrupted turns',
